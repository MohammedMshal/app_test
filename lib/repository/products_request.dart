...
Future<ProductsProviderModel> networkProducts(
  ...
  if (productsProviderModel.products != null &&
      productsProviderModel.products.length > 0 &&
      productsProviderModel.categoryId == categoryId) {
