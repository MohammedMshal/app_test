...
Future<ResponseCountries> networkGetCountries() async {
...
//  queryParameters['data'] = data;
  try {
    response = await dio.get('$kCountriesApi').whenComplete(() {});
  } on DioError catch (e) {
    if (e.response != null) {
  ...
  try {
    ...
    if (basicResponse.code == 200) {
      ResponseCountries apiProfileResponse = ResponseCountries.fromMap(response.data);
