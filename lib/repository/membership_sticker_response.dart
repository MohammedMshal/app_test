...
Future<List<MembershipSticker>> networkMembershipSticker() async {
...
//  queryParameters['data'] = data;
  try {
    response = await dio.post('$kMembershipStickerApi').whenComplete(() {});
  } on DioError catch (e) {
    if (e.response != null) {
  ...
  try {
    ...
    if (basicResponse.code == 200) {
      ResponseMembershipStickers coinsResponse = ResponseMembershipStickers.fromMap(response.data);
      Echo('response');
