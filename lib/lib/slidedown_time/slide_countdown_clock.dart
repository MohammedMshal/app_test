  ...
  Widget _buildDigit(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        if(id=="seconds")
          Text("ثانية",style: TextStyle(fontSize: 10,color: Colors.black),),
        if(id=="minutes")
          Text("دقيقة",style: TextStyle(fontSize: 10,color: Colors.black),),
        if(id=="Hours")
          Text("ساعة",style: TextStyle(fontSize: 10,color: Colors.black),),
        if(id=="Days")
          Text("يوم",style: TextStyle(fontSize: 10,color: Colors.black),),
      ],
    );
  }
}
