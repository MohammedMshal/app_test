...
class DatabaseHelper {
  static final _databaseName = "kokylive3.db";
  static final _databaseVersion = 1;

  static final table = 'motors';

  static final columnId = 'id';
  static final columnProductNumber = 'productNumber';
  ...
  static final columnModal = 'modal';
  ...
  Future<List<Map<String, dynamic>>> select(int productId) async {
    Database db = await instance.database;
    return await db
        .query(table, where: '$columnProductId = ?', whereArgs: [productId]);
  }
  ...
  Future<int> update(Map<String, dynamic> row) async {
    ...
    return await db
        .update(table, row, where: '$columnProductId = ?', whereArgs: [id]);
  }
  ...
  Future<int> removeProduct(int productId) async {
    Database db = await instance.database;
    return await db
        .delete(table, where: '$columnProductId = ?', whereArgs: [productId]);
  }
